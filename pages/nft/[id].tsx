...
export default function NFTDropPage() {
	...
	return (
		<div className='flex h-screen flex-col lg:grid lg:grid-cols-10'>
			<Head>
				<title>The PAPAFAM NFT</title>
			</Head>
			{/* Left */}
			<div className='bg-gradient-to-br from-cyan-800 to-rose-500 col-span-4'>
				<div className='flex flex-col text-center items-center justify-center py-2 lg:min-h-screen'>
			...
			<div className='flex flex-1 flex-col p-12 lg:col-span-6'>
				...
				<header className='flex items-center justify-between'>
					...
					<button
						...
						className='rounded-full bg-rose-400 px-4 py-2 text-xs text-white lg:text-base lg:px-5 lg:py-3'
					>
				...
				<div className='mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0 lg:justify-center'>
					...
					<p className='text-xl pt-2 text-green-500 '>
						13/21 NFT&apos;s claimed
					</p>
				</div>
				{/* Mint Button */}
